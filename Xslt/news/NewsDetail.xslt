  ...
  <xsl:template match="/">
    <div class="container">
      <div class="row flex flex-wrap">
        ...
        <div class="col-xs-12 col-lg-3"><xsl:value-of select="count(/NewsDetail/ProductRelated)"/>
	 ...
	 <xsl:if test="count(/NewsDetail/ProductRelated2)>0" >
      <div class="banner-ads-hidden">
        <div class="productlist">
          <div class="row flex flex-wrap">
            <xsl:apply-templates select="/NewsDetail/ProductRelated2"></xsl:apply-templates>
          </div>
        </div>
      </div>
    </xsl:if>
