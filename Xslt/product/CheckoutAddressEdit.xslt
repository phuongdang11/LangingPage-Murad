      ...
      <section class="cart-form clearfix">
        <div class="group clearfix">
          <section class="form-group">
            ...
            <div class="input">
              <input type="text" id="Address_FirstName" name="Address_FirstName" placeholder="Nhập họ tên" class="o2o-fullName">
          ...
          <section class="form-group">
            ...
            <div class="input phone">
              <input type="text" id="Address_Phone" name="Address_Phone" placeholder="Nhập Số điện thoại" class="o2o-phone">
                <xsl:attribute name="value">
          ...
          <section class="form-group">
            ...
            <div class="input">
              <input type="text" id="Address_Email" name="Address_Email" placeholder="Nhập email" class="o2o-email">
                <xsl:attribute name="value">
          ...
          <section class="form-group">
            ...
            <div class="input">
              <select id="Address_Province" name="Address_Province" onchange="AjaxCheckout.getdistrictsbyprovinceguid(this, 'Address_District')" class="o2o-address">
                <option value="">
          ...
          <section class="form-group">
            ...
            <div class="input">
              <select id="Address_District" name="Address_District" onchange="AjaxCheckout.getwardbydistrictguid(this, 'Address_Ward')" class="o2o-address">
                <option value="">
            ...
            <div class="input">
              <select id="Address_Ward" name="Address_Ward" class="o2o-address">
                <option value="">
          ...
          <section class="form-group">
            ...
            <div class="input">
              <input type="text" id="Address_Address" name="Address_Address" placeholder="Vd: 64 đường Hiệp Bình" class="o2o-address">
                <xsl:attribute name="value">
          ...
          <section class="form-group">
            ...
            <div class="input">
              <textarea id="OrderNote" name="OrderNote" cols="30" rows="2" placeholder="Ví dụ: Chuyển hàng ngoài giờ hành chính" class="o2o-note">
    ...
    <section class="cart-button clearfix">
      ...
      <button id="checkout" name="checkout" class="btn-continue">
        <xsl:attribute name="onclick">
          ...
          <xsl:text>', false);return false;</xsl:text>
        </xsl:attribute>
