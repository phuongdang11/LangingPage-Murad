...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">
  ...
  <xsl:template match="/">
	...
	<div class="mobiledevice">
		<div class="addtocart-fly-button">
			<a href="#!" class="buynow-fly-button" id="addtocartdetail-mobile" data-action="addcart" data-url='' onclick="AjaxCart.addproducttocart_details(this); return false;">
			  <xsl:attribute name="data-productid">
				<xsl:value-of select="/ProductDetail/ProductId"></xsl:value-of>
			  </xsl:attribute>
			  <xsl:attribute name="data-siteid">
			  ...
			  <xsl:if test="/ProductDetail/ButtonColor=''">
				<xsl:attribute name="style">
				  <xsl:text>background:#fba81c</xsl:text>
				</xsl:attribute>
			  </xsl:if>
			  <xsl:text>Thêm vào giỏ hàng</xsl:text>
			</a>
