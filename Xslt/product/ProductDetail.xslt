          ...
          <div class="col-xs-12 col-lg-6">
            <div class="product-fly-button clearfix">
              <section class="product-info clearfix wow fadeInRight">
                ...
                <xsl:if test="/ProductDetail/StockQuantity > 0">      
                  <xsl:choose>
                ...
                <xsl:if test="/ProductDetail/StockQuantity  &lt; 1">   
                 <a href="#" class="buynow hvr-sweep-to-right btn-contact" data-toggle="modal" data-target="#formProductContact">
